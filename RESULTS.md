...
| shape error ≤ 5% | 0.61% | MET | normalised area error, measured in ViennaPS |

**PROJECT VERDICT: UNREACHABLE** — 2 of 3 clauses met; speedup ≥ 1000× is not.

The binding clause is the speedup. The honest like-for-like figure is **1.5×** against a **1000×** target — short by a factor of **679**, not by a margin that a better implementation closes. Timing the solver as 10 concurrent processes instead of 1 would have read 1006× and passed the clause on an artefact of the denominator; that reading is in the grid below and is not the KPI number.
...
|---|---|---|---|---|
| true recipe, re-simulated (tripwire) | 0.0024 | 0.0024 | 0.0030 | 0.020 |
| **gradient descent, scored in ViennaPS** | 0.0061 | 0.0060 | 0.0081 | 0.036 |
| gradient descent, surrogate's own opinion | 0.0072 | 0.0068 | 0.0106 | 0.035 |
| random search over the operator, 256 candidates | 0.0233 | 0.0178 | 0.0432 | 0.116 |
...
|---|---|---|---|---|
| T searched (no duration given) | 0.0061 | 0.0098 | 100% | 0.036 |
...
|---|---|---|---|
| runs/design_Tfree.json (seed1) | 0.0061 | 0.0098 | 100% |
| design_Tfree_seed2.json | 0.0064 | 0.0110 | 100% |

Across 2 seeds: mean **0.0062**, range **0.0003**, worst seed **0.0064** against the 0.05 threshold. Every seed meets the clause.
...
| clause 3 — inverse design | `runs/design_Tfree.json` | found | 2026-09-09 05:13 UTC |
...
| seed spread | `runs/seed_spread.json` | found | 2026-09-10 07:36 UTC |
| GPU lease health | `runs/gpu_health.json` | found | 2026-09-09 04:21 UTC |

### Noise floor

Largest within-configuration range across seeds: **0.00114** (7 seeds in the largest arm). An effect smaller than this is not an effect.
